...
{
	   if(!((this->multimediaManager->SetVideoAdaptationLogic((LogicType)this->gui->GetAdaptationLogic()) && (this->multimediaManager->SetAudioAdaptationLogic((LogicType)this->gui->GetAdaptationLogic())))))
	   {
	   ...
	   this->multimediaManager->Start(this->gui->GetNDNStatus());
}
