...
MultimediaStream::MultimediaStream  (StreamType type, IMPD *mpd, uint32_t bufferSize, uint32_t frameBufferSize, uint32_t sampleBufferSize, bool ndnEnabled) :
                		  type              (type),
...
{
	this->dashManager   = new DASHManager(this->type, this->segmentBufferSize, this, this->mpd, this->IsNDN());
